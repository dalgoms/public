        ...
        <div className="max-w-[960px] mx-auto">
          ...
          <div>
            <div className="text-center">
              <h1 className="mx-auto font-sans font-semibold tracking-tight leading-tight text-[clamp(2.6rem,5vw,4rem)]">
              ...
              <p className="mx-auto mt-6 max-w-[720px] text-xl sm:text-2xl text-neutral-400">
                {subheadline ? (
                  subheadline
                ) : (
                  <>
            ...
            {/* Inline product info removed in favor of hover tooltip above */}
          </div>
        </div>
      </div>
    </section>
